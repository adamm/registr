...
BEGIN TRANSACTION;
CREATE TABLE users (id integer primary key autoincrement not null, username varchar(25) not null, password varchar(25) not null, email varchar(255) not null, balance float(10,2) not null default 0, cc_num varchar(16), cc_exp varchar(4), cc_cve varchar(3));
